export const chickCareKnowledge = [
  'Chicks need access to a warm area and a cooler area so they can choose where they are comfortable.',
  'Huddling near the heat source can mean chicks are cold, but it can also happen while they are resting.',
